...
static
struct st_node *
list_end_node(struct st_list * list)
{
...
struct st_node *
list_get(struct st_list * list, int index)
{
...
struct st_node *
list_search(struct st_list * list, int (*match)(void *))
{
  struct st_node * node = list->head;
  while (node != 0)
...
void
list_append(struct st_list * list, void * target)
{
  // create a new node
