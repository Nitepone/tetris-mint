...
void
resize_blob(Blob * blob, int length)
{
...
void
shift_blob(Blob * blob, int shift)
{
...
void
set_string_array(StringArray * arr, int index, char * value)
{
...
char *
get_string_array(StringArray * arr, int index, char * value)
{
	return arr->strings[index];
}

Blob *
serialize_string_array(StringArray * arr)
{
...
StringArray *
deserialize_string_array(Blob * blob)
{
